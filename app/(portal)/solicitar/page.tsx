...
export default function RequestsPage() {
    ...
    const handleRequestSubmit = async (type: CreateRequestData['type'], details: CreateRequestData['details']) => {
        ...
        // Corrigido para usar stay.cabin.name que já é populado pelo GuestProvider
        const cabinName = stay.cabin?.name || 'Cabana não especificada';

        const requestData: CreateRequestData = {
          stayId: stay.id,
          guestName: guest.displayName || stay.guestName,
          cabinName: cabinName,
          type,
          details,
        };
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Peça itens ou solicite serviços para sua cabana.</p>
            </div>
