// ARQUIVO: app/admin/(dashboard)/layout.tsx
// (Note: Baseado no seu arquivo correto, com os modais de manutenção adicionados)
...
// --- 1. INÍCIO DAS ADIÇÕES (IMPORTAR MODAIS) ---
// (Presumindo que DelegateTaskDialog já existe com base no seu modal store)
import { DelegateTaskDialog } from '@/components/admin/maintenance/DelegateTaskDialog';
// (O novo modal que acabamos de criar)
import { ReviewTaskModal } from '@/components/admin/maintenance/ReviewTaskModal';
// --- FIM DAS ADIÇÕES ---
      ...
      <PropertyProvider>
        ...
        */}
        <NotificationProvider>
          ...
          {/* --- 2. INÍCIO DAS ADIÇÕES (RENDERIZAR MODAIS) --- */}
          <DelegateTaskDialog staff={[]} />
          <ReviewTaskModal />
          {/* --- FIM DAS ADIÇÕES --- */}
