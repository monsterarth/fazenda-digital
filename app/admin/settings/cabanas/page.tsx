...
import { Loader2, PlusCircle, Edit, Trash2, BedDouble } from 'lucide-react';

// --- Esquema de validação para o formulário da cabana (CORRIGIDO) ---
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Adicione, edite ou remova as acomodações disponíveis.</CardDescription>
                    </div>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {cabins.length > 0 ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={4} className="h-24 text-center">Nenhuma cabana cadastrada.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Preencha as informações abaixo e clique em salvar.
                        </DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
                        <form id="cabin-form" onSubmit={form.handleSubmit(handleSaveCabin)} className="space-y-4 py-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Nome da Cabana</FormLabel>
                                        <FormControl><Input placeholder="Ex: Cabana da Praia 1" {...field} /></FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="number" min="1" {...field} onChange={e => field.onChange(e.target.value === '' ? undefined : Number(e.target.value))} /></FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                />
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="number" min="1" {...field} value={field.value ?? ''} onChange={e => field.onChange(e.target.value === '' ? undefined : Number(e.target.value))}/></FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                />
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta ação não pode ser desfeita. Isso excluirá permanentemente a cabana "{cabinToDelete?.name}" do banco de dados.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
