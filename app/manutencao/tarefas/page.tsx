// app/manutencao/tarefas/page.tsx
...
// ## INÍCIO DA CORREÇÃO ##
// Atualiza os caminhos de importação para usar o alias '@'
            ...
            <main className="p-4">
                <Tabs defaultValue="pending">
                    <TabsList className="grid w-full grid-cols-3">
                        ...
                        <TabsTrigger value="in_progress">Em Andamento ({inProgressTasks.length})</TabsTrigger>
                    ...
                    <TabsContent value="pending" className="space-y-4 mt-4">
                        {pendingTasks.length > 0 ? (
                            ...
                            <p className="text-center text-gray-500 pt-10">Nenhuma tarefa pendente.</p>
                        )}
                    </TabsContent>
                    ...
                    <TabsContent value="in_progress" className="space-y-4 mt-4">
                        {inProgressTasks.length > 0 ? (
                            ...
                            <p className="text-center text-gray-500 pt-10">Nenhuma tarefa em andamento.</p>
                        )}
                    </TabsContent>
                    ...
                    <TabsContent value="completed" className="space-y-4 mt-4">
                        {completedTasks.length > 0 ? (
                            ...
                            <p className="text-center text-gray-500 pt-10">Nenhuma tarefa concluída recentemente.</p>
                        )}
                    </TabsContent>
                </Tabs>
            </main>
